<template>
  ...
  <div v-if="show">
    <el-form label-position="top">
      ...
      <el-form-item label="对齐方式" v-if="Object.keys(data.options).indexOf('textAlign')>=0">
        <el-radio-group v-model="data.options.textAlign">
      ...
      <el-form-item label="默认值" v-if="Object.keys(data.options).indexOf('defaultValue')>=0 && (data.type == 'textarea' || data.type == 'input' || data.type=='rate' || data.type=='color' || data.type=='switch'|| data.type=='text')">
      ...
      <el-form-item label="行高" v-if="Object.keys(data.options).indexOf('lineHeight')>=0">
        <el-input-number v-model="data.options.lineHeight" :min="0" :max="100" :step="1"></el-input-number>
      </el-form-item>
      ...
      <template v-if="data.type == 'time' || data.type == 'date'">
        <el-form-item label="显示类型" v-if="data.type == 'date'">
          <el-select v-model="data.options.type">
            ...
            <el-option value="date">日</el-option>
            <el-option value="dates">多个日期</el-option>
            <el-option value="daterange">日期范围</el-option>
            <!-- <el-option value="week"></el-option> -->
            <el-option value="datetime">日期和时间</el-option>
            <el-option value="datetimerange">日期和时间范围</el-option>
      ...
      <template v-if="data.type != 'grid'">
        ...
        <el-form-item label="操作属性">
          <el-checkbox v-model="data.options.display" v-if="Object.keys(data.options).indexOf('display')>=0">隐藏</el-checkbox>
